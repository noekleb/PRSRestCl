...
DEFINE FRAME DEFAULT-FRAME
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SCROLLABLE SIZE 76.8 BY 16.67 WIDGET-ID 100.
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   FRAME-NAME                                                           */
ASSIGN 
       FRAME DEFAULT-FRAME:HEIGHT           = 16.67
       FRAME DEFAULT-FRAME:WIDTH            = 76.8.
...
OCXFile = SEARCH( "BrowserWindow.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "BrowserWindow.wrx":U SKIP(1)
...
DO WITH FRAME {&FRAME-NAME}:
    chCtrlFrame:WebBrowser:Navigate (cURL). 
END.
